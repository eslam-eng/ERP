                    ...
                    <div class="box box-primary">
                        ...
                        <form action="{{route('customers.store')}}" method="post" role="form" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-4">
                                        ...
                                        <input type="tel" name="mobile" class="form-control" value="{{old('mobile')}}" id="socialnumber">
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-4">
                                        ...
                                        <input type="text" name="nationalId" class="form-control" value="{{old('nationalId')}}" id="socialnumber">
                                    </div>
                                    ...
                                    <div class="col-xs-4">
                                        <label>{{trans('trans.dept')}} </label>
                                        <input type="number" name="dept" class="form-control" value="0">
                                    </div>
                                    @if($errors->has('dept'))
                                        <h5 class="text-danger pull-right">
                                ...
                                <div class="row">
                                    <div class="form-group col-xs-8">
                                        ...
                                        <input type="text" name="address" class="form-control calc" id="address" value="{{old('address')}}">
                                    </div>
                            ...
                            <div class="box-footer">
                                <div class="row">
                                    <div class="col-md-9"><button type="submit" class="btn btn-primary"><i class="fa fa-send"></i> {{trans('trans.submit')}} </button></div>
                                    <div class="col-md-3"><a href="{{route('customers.index')}}" role="button" class="btn btn-default btn-sm pull-right"><i class="fa fa-backward"></i> {{trans('trans.back')}} </a></div>
                                </div>
                            </div>
                        </form>
                    </div>
