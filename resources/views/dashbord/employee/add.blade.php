    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">{{trans('trans.Add_employee')}}</li>
            </ol>
        </section>
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-xs-2">
                                        ...
                                        <input type="number" name="salary" id="salary" class="form-control" value="1500">
                                    </div>

                                    <div class="col-xs-2">
                                        <label for="num_days">{{trans('trans.num_days')}}</label>
                                        <input type="number" name="numDays" id="num_days" value="{{old('numDays')}}" class="form-control">
                                    </div>
                                    <div class="col-xs-2">
                                        <label for="num_hours">{{trans('trans.num_hours')}}</label>
                                        <input type="number" name="numHours" id="num_hours" value="{{old('numHours')}}" class="form-control">
                                    </div>
                                    ...
                                    <div class="col-xs-2">
                                        ...
                                        <input type="number" name="S_perHour" id="S_perHour" value="0" class="form-control" readonly>
                                    </div>

                                    <div class="col-xs-3">
                                        <label for="balance">{{trans('trans.balance')}}</label>
                                        <input type="number" name="balance" value="0" id="balance"  class="form-control">
                                    </div>
                                </div><br>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-4">
                                        ...
                                        <input type="tel" name="mobile"  class="form-control calc" id="tele" value="{{old('tele')}}" placeholder="Your Mobile Number">
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-4">
                                        ...
                                        <input type="text" name="nationalId" class="form-control calc" value="{{old('nationalId')}}" id="socialnumber" placeholder="Social Number">
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-4">
                                        ...
                                        <input type="text" name="job" class="form-control" id="job" value="{{old('job')}}" placeholder="your job....">
                                    </div>

                                    <div class="form-group col-xs-8">
                                        <label for="address">{{trans('trans.address')}}</label>
                                        <input type="text" name="address" class="form-control calc" id="address" value="{{old('address')}}" placeholder="adress">
                                    </div>
