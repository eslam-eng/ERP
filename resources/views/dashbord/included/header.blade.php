...
<head>
    ...
    <link rel="stylesheet" href="{{asset('dashbord/dist/css/Chart.min.css')}}">

    @if(session('lang')=='ar')
        <link rel="stylesheet" href="{{asset('dashbord/dist/css/rtl/bootstrap-rtl.min.css')}}"/>
        <link rel="stylesheet" href="{{asset('dashbord/dist/css/rtl/AdminLTE-rtl.css')}}"/>
        <link rel="stylesheet" href="{{asset('dashbord/dist/css/rtl/_all-skins-rtl.css')}}"/>
        <style>
            .datepicker {
...
{{--    <link rel="stylesheet" href="{{asset('dashbord/dist/css/skins/_all-skins.min.css')}}">--}}
    ...
    <!-- DataTables -->
    <link rel="stylesheet" href="{{asset('dashbord/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css')}}">

    <!-- Select2 -->
    <link rel="stylesheet" href="{{asset('dashbord/bower_components/select2/dist/css/select2.min.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('dashbord/plugins/timepicker/bootstrap-timepicker.min.css')}}">

    <link rel="stylesheet" href="{{asset('dashbord/dist/css/toast.min.css')}}">
...
{{--<head>--}}
    ...
    {{--<link rel="stylesheet" href="{{asset('dashbord/dist/css/checkbox.css')}}">--}}
    ...
    {{--<link rel="stylesheet" href="{{asset('dashbord/dist/css/iziToast.min.css')}}">--}}
    {{--<!-- DataTables -->--}}
    {{--<link rel="stylesheet" href="{{asset('dashbord/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css')}}">--}}
