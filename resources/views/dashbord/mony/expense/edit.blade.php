            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <!-- form start -->
                        <form action="{{route('DailyExpense.update',$dailyExpense->id)}}" method="post" role="form" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control" name="genralexpense" value="{{$dailyExpense->genralexpense}}" id="employee">
                                    </div>
                                ...
                                <div class="row"  id="expensevalue">
                                    <div class="col-xs-3">
                                        ...
                                        <input type="number" name="value" value="{{$dailyExpense->value}}" min="0" class="form-control">
                                    </div>
                                    @if($errors->has('value'))
                                ...
                                <div class="row" id="expenseInput">
                                    <div class="col-xs-3">
                                        ...
                                        <input type="text" name="maker" value="{{$dailyExpense->maker}}" class="form-control">
                                    </div>
                                    @if($errors->has('maker'))
                                        <h5 class="text-danger pull-right">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="note" rows="1" >{{$dailyExpense->note}}</textarea>
                                </div>
                                @if ($errors->has('note'))
