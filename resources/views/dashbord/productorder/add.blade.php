...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <h3>
                <a role="button" href="{{route('productorder.show',1)}}" class="btn btn-primary">
                    {{trans("trans.allproductsorder")}}
                </a>
            </h3>
    ...
    <script>
        ...
        function getRowView(product) {
            ...
            row +=
                ...
                '<td><input type="number"  onkeyup="checkQty(this)" data-id="'+product.id+'" data-qty="'+product.qty+'" name="amount[]" min="1" max="'+product.qty+'" class="form-control amount" value='+ amount +'></td>' +
                        ...
                        swal({
                            ...
                            .then((willDelete) => {
                                if (willDelete) {
                                    ...
                                    window.location.replace('{{route('productorder.index')}}');
                                }
                            });
                    }
