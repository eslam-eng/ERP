    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">{{trans('trans.updatestore')}}</li>
            </ol>
        </section>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <!-- form start -->
                        <form action="{{route('stock.update',$stock->id)}}" method="post" role="form">
                            @csrf
                            @method('PUT')
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-xs-6">
                                        ...
                                        <input type="text" name="name" class="form-control" value="{{$stock->name}}" id="name">
                                    </div>

                                    <div class="col-xs-6">
                                        <label for="desc">{{trans('trans.descriotion')}}</label>
                                        <input type="text" name="desc" class="form-control" value="{{$stock->desc}}" id="desc">
                                    </div>
                                </div><br>
                                ...
                                <div>
                                    <input type="checkbox" id="isactive" name="isactive" {{$stock->isactive==1?'checked':''}}>
