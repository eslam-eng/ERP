                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-xs-6">
                                        ...
                                        <input type="text" name="responsible" class="form-control" value="{{$supplier->responsible}}" id="name" >
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-5">
                                        ...
                                        <input type="tel" name="mobile" id="mobile" value="{{$supplier->mobile}}" class="form-control">
                                    </div>

                                    <div class="col-xs-5">
                                        <label for="email">{{trans('trans.email')}}</label>
                                        <input type="email" name="email" id="emil" value="{{$supplier->email}}" class="form-control">
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-xs-8">
                                        ...
                                        <input type="text" name="address" class="form-control calc" id="address" value="{{$supplier->address}}">
                                    </div>
...
{{--                                        <input type="number" name="balance" class="form-control" id="balance" value="{{$supplier->balance}}">--}}
{{--                                    </div>--}}
...
{{--                                    @endif--}}
                                ...
                                <div>
                                    <input type="checkbox" id="isactive" name="isactive" value="{{$supplier->isactive}}" {{$supplier->isactive==1?'checked':''}}>
                            ...
                            <div class="box-footer">
                                <div class="row">
                                    <div class="col-md-8"><button type="submit" class="btn btn-primary"><i class="fa fa-send"></i> {{trans('trans.update')}}</button></div>
